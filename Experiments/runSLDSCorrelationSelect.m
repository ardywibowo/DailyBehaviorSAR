...
resultName = 'Remove - WorkoutCalories';
playSound = 1;
...
%% Import User Data
[datasetName, rangeData, numSubjects, ~, bmiTrain, inputTrain, bmiTest, bmiMissing, inputTest, inputMissing, time] = importDailyBehavioralSmall();
